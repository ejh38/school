...
/*				String copyName = copyInfo[0];
				int copyX = Integer.parseInt(copyInfo[1]);
				int copyY = Integer.parseInt(copyInfo[2]);
				int copySize = Integer.parseInt(copyInfo[3]);
				if (copyName.equals("Greeting"))
				{
					String shapeText = copyInfo[4];
				}		
*/				copying = true;
				menuCopy.setEnabled(false);
				menuCut.setEnabled(false);
