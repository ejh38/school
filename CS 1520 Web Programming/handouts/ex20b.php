...
<html>
<head>
<title>CS 1520 PHP Example 20b</title>
</head>
<body>
<?php
   ...
   if (!$started):
       ...
       echo "<a href = \"ex20.php\">Quote Site</a>";
       session_destroy();
       die("</h2></center>");
   endif;
   ...
   if ($rows < 1):
       ...
       echo "<a href = \"ex20.php\">Try Again</a>";
       session_destroy();
       die("</h2></center>");
   endif;
...
<?php
   ...
   # For comments on the submit below, see ex20c.php
?>
