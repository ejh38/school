...
<html>
 ...
 <?php
      ...
      # our server normal users do not have permission to do this.  Thus, the
      # administrator created the actual database, and I am simply 
      # adding tables and data to it.
      ...
      # good idea.  I put mine within a .php file so that at least it would
      # be difficult (but not impossible) for someone to read it.  Naturally, 
      # substitute your id and password below when using this example.  If you
      # create a production Web site, look up on the Web more info about storing
      # MySQL passwords.
