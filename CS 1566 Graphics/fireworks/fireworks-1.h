...
#ifndef _FIREWORKS_1_H_
#define _FIREWORKS_1_H_
#endif
...
typedef struct _Shape {
	...
	GLfloat shape_verts[121][121][4];		// vertices for the shape
...
void draw_cube(GLfloat vertices[121][121][4], int iv1a, int iv1b, int iv2a, int iv2b, int iv3a, int iv3b, int iv4a, int iv4b, int ic);
