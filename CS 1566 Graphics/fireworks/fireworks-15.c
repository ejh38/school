...
GLfloat cur_radius = 700;
GLfloat cur_density = 1;
int cur_quantity = 64;
GLfloat cur_cube_size = .02;
int cur_after_counter = 1000;
int cur_shape = 1;
...
void my_keyboard( unsigned char key, int x, int y ) 
{
  ...
  case '0': {
    make_explosion(&explosions[3], cur_radius, cur_density, cur_quantity, cur_cube_size, cur_after_counter, cur_shape, test_sound, (&nozzles[3])->x, (&nozzles[3])->y + 1);
  } break;
