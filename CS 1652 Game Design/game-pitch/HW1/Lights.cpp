...
Lights::Lights ()
    :
    WindowApplication3("HW/1", 0, 0, 800, 600,
...
void Lights::CreateScene ()
{
	...
	myShape0 = sm.Dodecahedron();
	myShape0->LocalTransform.SetTranslate(APoint(0.0f, +4.0f, 2.0f));
    myShape0->SetEffectInstance(mInstance[0][1][1]);
    mScene->AttachChild(myShape0);
	
	myShape1 = sm.Cylinder(40, 40, 1, 3, 0);
	myShape1->LocalTransform.SetTranslate(APoint(0.0f, +2.0f, 2.0f));
    myShape1->SetEffectInstance(mInstance[0][1][1]);
    mScene->AttachChild(myShape1);
	
	myShape2 = sm.Torus(40, 40, 2, .6);
	myShape2->LocalTransform.SetTranslate(APoint(0.0f, -2.0f, 2.0f));
    myShape2->SetEffectInstance(mInstance[0][1][1]);
    mScene->AttachChild(myShape2);
	
	myShape3 = sm.Box(1, 2.5, 2);
	myShape3->LocalTransform.SetTranslate(APoint(0.0f, -8.0f, 2.0f));
    myShape3->SetEffectInstance(mInstance[0][1][1]);
    mScene->AttachChild(myShape3);
